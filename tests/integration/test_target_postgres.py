...
from target_greenplum import RecordValidationException
from target_greenplum.db_sync import DbSync
...
class TestIntegration(unittest.TestCase):
    ...
    def test_invalid_json(self):
        ...
        with self.assertRaises(json.decoder.JSONDecodeError):
            target_greenplum.persist_lines(self.config, tap_lines)
    ...
    def test_column_name_change(self):
        ...
        # Load with default settings
        target_greenplum.persist_lines(self.config, tap_lines_before_column_name_change)
        target_greenplum.persist_lines(self.config, tap_lines_after_column_name_change)
    ...
    @mock.patch('target_greenplum.emit_state')
