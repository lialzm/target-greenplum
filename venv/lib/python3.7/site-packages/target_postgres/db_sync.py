...
class DbSync:
    def __init__(self, connection_config, stream_schema_message=None):
        ...
        self.logger = get_logger('target_geenplum')
    ...
    def record_to_csv_line(self, record):
        self.logger.info('record_to_csv_line')
        self.logger.info(record)
        self.logger.info('record_to_csv_line_end')
        flatten = flatten_record(record, self.flatten_schema, max_level=self.data_flattening_max_level)
        self.logger.info('flatten')
        self.logger.info(flatten)
        self.logger.info(self.flatten_schema)
        self.logger.info('flatten_end')
        return ','.join(
            [
